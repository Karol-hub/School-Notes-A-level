...
\begin{figure}[h]
\includegraphics[scale=0.8]{ROR 2 ss}
...
\myparagraph{What I would include}
\begin{itemize}
...
\subsection{Celeste}
\begin{figure}[h]
\includegraphics[scale=0.8]{Celeste ss}
\caption{\cite{Css} Celeste Screen shot}
\end{figure}
...
\begin{figure}[h]
\includegraphics[scale=0.8]{Rain world ss}
...
Steam does a hardware analysis on all of it's users every month so I will be able to make a game that will meet the requirements of the majority of players. So all the data in this section is taken from \cite{SHWS}

\myparagraph{System OS}
Deciding which systems I will be able to support is going to be an important decision I have to make to make sure that the users can play the game us
