...
Begin with generating a defined amount of rooms. Rooms are pre-made layouts that a room as seen in figure \ref{Room Layout}

\begin{figure}[h]
\centering
\includegraphics[width = 0.4\textwidth]{room layout}
\caption{Room Layout}
\label{Room Layout}
\end{figure}
