...
\newcommand{\testImageSize}{0.22\textwidth}
...
\hline
\textbf{Methodology} & \multicolumn{1}{c|}{\textbf{Description}}                                                                                                                                                         & \multicolumn{1}{c|}{\textbf{Uses}}                                                                                                                          & \multicolumn{1}{c|}{\textbf{Advantages}}                                                                                                                      & \multicolumn{1}{c|}{\textbf{Disadvantages}}                                                                                                                             \\ \hline
...
\hline
\begin{tabular}[c]{@{}l@{}}\textbf{Goal}\\ \textbf{Num}\end{tabular} & \textbf{Input} & \textbf{Aim}                                                                                & \textbf{Justification}                                              \\ \hline
1                                                  & None  & \begin{tabular}[c]{@{}l@{}}Executes in a reasonable \\ amount of time\end{tabular}  & Annoying for player to wait too long for level to generate                                                                                  \\ \hline
2                                                  & None  & \begin{tabular}[c]{@{}l@{}}There is correct amount\\ of rooms\end{tabular}          & \begin{tabular}[c]{@{}l@{}}Too much and a level will take too long to generate, too little \\ and the map won't be interesting\end{tabular} \\ \hline
3                                                  & None  & \begin{tabular}[c]{@{}l@{}}There is variation in the\\ rooms generated\end{tabular} & Makes it more interesting for the player as there is less repetition                                                                        \\ \hline
\end{tabular}
\end{table}
...
\begin{tabular}[c]{@{}l@{}}\textbf{Goal}\\ \textbf{Num}\end{tabular} & \textbf{Input} & \textbf{Aim}                                                                                & \textbf{Justification}                                              \\ \hline
1                                                  & None  & \begin{tabular}[c]{@{}l@{}}Executes in a reasonable \\ amount of time\end{tabular} & Annoying for player to wait too long for level to generate                                                               \\ \hline
2                                                  & None  & \begin{tabular}[c]{@{}l@{}}Room are still close \\ together\end{tabular}           & Making the player travel for too long won't be fun                                                                       \\ \hline
3                                                  & None  & Rooms don't overlap                                                                & \begin{tabular}[c]{@{}l@{}}Want to rooms to generate correctly, without overalp as\\ it may cause artifacts\end{tabular} \\ \hline
\end{tabular}
\end{table}
...
\begin{tabular}[c]{@{}l@{}}\textbf{Goal}\\ \textbf{Num}\end{tabular} & \textbf{Input} & \textbf{Aim}                                                                                & \textbf{Justification}                                                                                          \\ \hline
1                                                  & None  & \begin{tabular}[c]{@{}l@{}}Executes in a reasonable \\ amount of time\end{tabular} & Annoying for player to wait too long for level to generate \\ \hline
2                                                  & None  & \begin{tabular}[c]{@{}l@{}}Distance between rooms\\ varies\end{tabular}            & Making the player travel for too long won't be fun         \\ \hline
\end{tabular}
\end{table}
...
\begin{tabular}[c]{@{}l@{}}\textbf{Goal}\\ \textbf{Num}\end{tabular} & \textbf{Input} & \textbf{Aim}                                                                                & \textbf{Justification}                                              \\ \hline
1                                                  & None  & \begin{tabular}[c]{@{}l@{}}Executes in a reasonable \\ amount of time\end{tabular}        & Annoying for player to wait too long for level to generate                                                                    \\ \hline
2                                                  & None  & \begin{tabular}[c]{@{}l@{}}Every room is included\\ in the triangulation\end{tabular}     & \begin{tabular}[c]{@{}l@{}}This way every room will be included and have a chance\\ of existing in the final map\end{tabular} \\ \hline
3                                                  & None  & \begin{tabular}[c]{@{}l@{}}Triangulated in the most\\ efficient way possible\end{tabular} & \begin{tabular}[c]{@{}l@{}}There is as little as possible overlap when coridoors are\\ generated\end{tabular}                 \\ \hline
\end{tabular}
\end{table}
...
\begin{tabular}{|l|l|l|l|} 
\hline
\begin{tabular}[c]{@{}l@{}}\textbf{Goal}\\ \textbf{Num}\end{tabular} & \textbf{Input} & \textbf{Aim}                                                                       & \textbf{Justification}                                                                                                     \\ 
\hline
1                                                                    & None           & \begin{tabular}[c]{@{}l@{}}Executes in a reasonable \\ amount of time\end{tabular} & Annoying for player to wait too long for level to generate                                                                 \\ 
\hline
2                                                                    & None           & \begin{tabular}[c]{@{}l@{}}Random amount of edges\\ are removed\end{tabular}       & \begin{tabular}[c]{@{}l@{}}Every room won't be connected to every other room that's close\\ adding variation\end{tabular}  \\ 
\hline
3                                                                    & None           & \begin{tabular}[c]{@{}l@{}}Random edge is selected\\for removal\end{tabular}       & Doesn't bias any specific area when deleting edges~                                                                        \\
\hline
\end{tabular}
\end{table}
...
\begin{tabular}[c]{@{}l@{}}\textbf{Goal}\\ \textbf{Num}\end{tabular} & \textbf{Input} & \textbf{Aim}                                                                                & \textbf{Justification}                                              \\ \hline
1                                                  & None  & \begin{tabular}[c]{@{}l@{}}Executes in a reasonable \\ amount of time\end{tabular}                             & Annoying for player to wait too long for level to generate                                                                                \\ \hline
2                                                  & None  & \begin{tabular}[c]{@{}l@{}}Spawn and room are\\ generated and connected\end{tabular}                                         & Gives the player a safe room to spawn in                                                                                                  \\ \hline
3                                                  & None  & \begin{tabular}[c]{@{}l@{}}Spawn is generated above\\ other rooms\end{tabular}                                 & \begin{tabular}[c]{@{}l@{}}Player needs to travel down to get to boss room, Gives\\ them a general direction to travel\end{tabular}       \\ \hline
4                                                  & None  & \begin{tabular}[c]{@{}l@{}}Boss room is generated \\ below of other rooms\end{tabular}                         & \begin{tabular}[c]{@{}l@{}}Gives the player a goal and way to progress into the\\ next player\end{tabular}                                \\ \hline
5                                                  & None  & \begin{tabular}[c]{@{}l@{}}Both rooms are generated\\ relatively close to the\\ horizontal center\end{tabular} & \begin{tabular}[c]{@{}l@{}}Having a room generate too far to left or right may \\ limit the rooms that the player can access\end{tabular} \\ \hline
\end{tabular}
\end{table}
...
\begin{tabular}[c]{@{}l@{}}\textbf{Goal}\\ \textbf{Num}\end{tabular} & \textbf{Input} & \textbf{Aim}                                                                                & \textbf{Justification}                                              \\ \hline
1                                                  & None  & \begin{tabular}[c]{@{}l@{}}Executes in a reasonable \\ amount of time\end{tabular}                   & Annoying for player to wait too long for level to generate                                                                                                                                                    \\ \hline
2                                                  & None  & \begin{tabular}[c]{@{}l@{}}An entire section is\\ detected given a single\\ input point\end{tabular} & \begin{tabular}[c]{@{}l@{}}Can detect all the points that are connected to the start point\\ to make sure that there is one section so that there is one\\ meaning that all rooms are accessible\end{tabular} \\ \hline
\end{tabular}
\end{table}
...
\begin{tabular}[c]{@{}l@{}}\textbf{Goal}\\ \textbf{Num}\end{tabular} & \textbf{Input} & \textbf{Aim}                                                                                & \textbf{Justification}                                                                                         \\ \hline
1                                                  & None  & \begin{tabular}[c]{@{}l@{}}Executes in a reasonable \\ amount of time\end{tabular}         & Annoying for player to wait too long for level to generate \\ \hline
2                                                  & None  & \begin{tabular}[c]{@{}l@{}}If point has already been\\ checked don't check it\end{tabular} & Don't want to detect the wrong amount of sections          \\ \hline
3                                                  & None  & \begin{tabular}[c]{@{}l@{}}Detect correct amount of\\ sections\end{tabular}                & When there is one section all rooms are accessible         \\ \hline
\end{tabular}
\end{table}
...
\begin{tabular}[c]{@{}l@{}}\textbf{Goal}\\ \textbf{Num}\end{tabular} & \textbf{Input} & \textbf{Aim}                                                                                & \textbf{Justification}                                                                                        \\ \hline
1                                                  & None  & \begin{tabular}[c]{@{}l@{}}Executes in a reasonable \\ amount of time\end{tabular} & Annoying for player to wait too long for level to generate \\ \hline
2                                                  & None  & \begin{tabular}[c]{@{}l@{}}All rooms are connected\\ to eachother\end{tabular}     & So the player can access all rooms                         \\ \hline
3                                                  & None  & \begin{tabular}[c]{@{}l@{}}Delete all rooms without\\ connections\end{tabular}     & removes all rooms that are inaccessible                    \\ \hline
\end{tabular}
\end{table}
...
\begin{tabular}[c]{@{}l@{}}\textbf{Goal}\\ \textbf{Num}\end{tabular} & \textbf{Input} & \textbf{Aim}                                                                                & \textbf{Justification}                                              \\ \hline
1                                                  & None  & \begin{tabular}[c]{@{}l@{}}Executes in a reasonable \\ amount of time\end{tabular}                & Annoying for player to wait too long for level to generate                                                                                                                         \\ \hline
2                                                  & None  & \begin{tabular}[c]{@{}l@{}}Entire map is made from\\ horizontal and vertical\\ edges\end{tabular} & \begin{tabular}[c]{@{}l@{}}Movement isn't designed for diagnal movement so having\\ only horizontal and vertical movement will make for a \\ better player experience\end{tabular} \\ \hline
\end{tabular}
\end{table}
...
\begin{tabular}[c]{@{}l@{}}\textbf{Goal}\\ \textbf{Num}\end{tabular} & \textbf{Input} & \textbf{Aim}                                                                                & \textbf{Justification}                                              \\ \hline
1                                                  & None  & \begin{tabular}[c]{@{}l@{}}Executes in a reasonable \\ amount of time\end{tabular}  & Annoying for player to wait too long for level to generate                                                 \\ \hline
2                                                  & None  & \begin{tabular}[c]{@{}l@{}}Each edge has a coridoor\\ generated for it\end{tabular} & Corridors allows players to traverse between rooms                                                         \\ \hline
3                                                  & None  & \begin{tabular}[c]{@{}l@{}}The corridor is an\\ appropriate size\end{tabular}       & \begin{tabular}[c]{@{}l@{}}Needs to be an appropriate size for player to fit into the\\ room.\end{tabular} \\ \hline
\end{tabular}
\end{table}
...
1                                                                    & None           & \begin{tabular}[c]{@{}l@{}}Executes in a reasonable \\ amount of time\end{tabular} & Annoying for player to wait too long for level to generate                                                                \\ 
\hline
2                                                                    & None           & \begin{tabular}[c]{@{}l@{}}Variation in the tiles looks\\ good\end{tabular}        & Makes it engaging for the player and more enjoyable                                                                       \\ 
\hline
3                                                                    & None           & Makes interesting map                                                              & \begin{tabular}[c]{@{}l@{}}Makes it entertaining for player to explore and actually able\\ to interact with\end{tabular}  \\ 
\hline
...
\begin{tabular}[c]{@{}l@{}}\textbf{Goal}\\ \textbf{Num}\end{tabular} & \textbf{Input} & \textbf{Aim}                                                                                & \textbf{Justification}                                              \\ \hline
1                                                  & None  & \begin{tabular}[c]{@{}l@{}}Executes in a reasonable \\ amount of time\end{tabular} & Annoying for player to wait too long for level to generate \\ \hline
2                                                  & None  & \begin{tabular}[c]{@{}l@{}}Player is spawned in\\ spawn room\end{tabular}          & Player starts in the spawn room                            \\ \hline
3                                                  & None  & \begin{tabular}[c]{@{}l@{}}Player is able to be\\ controlled\end{tabular}          & Player can start the game                                  \\ \hline
\end{tabular}
\end{table}
...
\hline
\begin{tabular}[c]{@{}l@{}}\textbf{Test }\\\textbf{Num}\end{tabular} & \textbf{Input} & \textbf{Expected Result}                                                                                & \textbf{Actual Result} & \textbf{Why it happened/What happened}                                                                                                 \\ 
\hline
1                                                                    & None           & \begin{tabular}[c]{@{}l@{}}Rooms generated in a \\dense section around \\coordinates (0,0)\end{tabular} & \raisebox{-.5\height}{\includegraphics[width = \testImageSize]{Failed to build}}             & \begin{tabular}[c]{@{}l@{}}Tried to access Node's position which doesn't\\~exist, need to access Area2D's position\end{tabular}  \\ 
\hline
2                                                                    & None           & \begin{tabular}[c]{@{}l@{}}Rooms generated in a \\dense section around \\coordinates (0,0)\end{tabular} & \raisebox{-.5\height}{\includegraphics[width = \testImageSize]{Nothing happened}}             & \begin{tabular}[c]{@{}l@{}}Forgot to assign a parent to the rooms so they \\didn't generate at all.\end{tabular}                 \\ 
\hline
3                                                                    & None           & \begin{tabular}[c]{@{}l@{}}Rooms generated in a \\dense section around \\coordinates (0,0)\end{tabular} & \raisebox{-.5\height}{\includegraphics[width = \testImageSize]{rooms generated successful}}             & \begin{tabular}[c]{@{}l@{}}Will be improved upon in the next iteration, \\but functions currently\end{tabular}                   \\
\hline
\end{tabular}
\end{table}
...
\begin{tabular}[c]{@{}l@{}}\textbf{Test }\\\textbf{Num}\end{tabular} & \textbf{Input} & \textbf{Expected Result}                                                      & \textbf{Actual Result} & \textbf{Why it happened/What happened}    \\ 
\hline
1                                                                    & None           & \begin{tabular}[c]{@{}l@{}}Rooms generated in a\\less dense area\end{tabular} & \raisebox{-.5\height}{\includegraphics[width = \testImageSize]{less dense gen}}             & Rooms are generated in a less dense area  \\
\hline
\end{tabular}
\end{table}
...
\begin{tabular}[c]{@{}l@{}}\textbf{Test }\\\textbf{Num}\end{tabular} & \textbf{Input} & \textbf{Expected Result}                                                & \textbf{Actual Result} & \textbf{Why it happened/What happened}                                                                                \\ 
\hline
1                                                                    & None           & \begin{tabular}[c]{@{}l@{}}Rooms structure has \\variation\end{tabular} & \raisebox{-.5\height}{\includegraphics[width = \testImageSize]{less dense gen room variations}}             & \begin{tabular}[c]{@{}l@{}}Difficult to tell but there is more variation\\in the structure of the rooms\end{tabular}  \\
\hline
\end{tabular}
\end{table}
...
\begin{tabular}[c]{@{}l@{}}\textbf{Test }\\\textbf{Num}\end{tabular} & \textbf{Input} & \textbf{Expected Result}                                                     & \textbf{Actual Result} & \textbf{Why it happened/What happened}    \\ 
\hline
1                                                                    & None           & \begin{tabular}[c]{@{}l@{}}Rooms structure has \\more variation\end{tabular} & \raisebox{-.5\height}{\includegraphics[width = \testImageSize]{room variations generation}} & Easier to tell with less rooms generated  \\
\hline
\end{tabular}
\end{table}
...
\begin{tabular}[c]{@{}l@{}}\textbf{Test }\\\textbf{Num}\end{tabular} & \textbf{Input} & \textbf{Expected Result}                                                            & \textbf{Actual Result} & \textbf{Why it happened/What happened}                                                                                                                                 \\ 
\hline
1                                                                    & None           & \begin{tabular}[c]{@{}l@{}}Rooms are spread apart\\without any overlap\end{tabular} & \raisebox{-.5\height}{\includegraphics[width = \testImageSize]{rooms seperated}}             & \begin{tabular}[c]{@{}l@{}}Eventually the program seperates all\\rooms, it did take around 40-50 seconds\\which is too long to be considered\\successful\end{tabular}  \\
\hline
\end{tabular}
\end{table}
...
\begin{tabular}{|l|l|l|l|l|} 
\hline
\begin{tabular}[c]{@{}l@{}}\textbf{Test }\\\textbf{Num}\end{tabular} & \textbf{Input} & \textbf{Expected Result}                                                                   & \textbf{Actual Result} & \textbf{What happened/Why it happened}                                                                                                                     \\ 
\hline
1                                                                    & None           & \begin{tabular}[c]{@{}l@{}}Rooms spread apart faster\\than previous iteration\end{tabular} & \raisebox{-.5\height}{\includegraphics[width = \testImageSize]{not responding}}              & \begin{tabular}[c]{@{}l@{}}Rooms get stuck on eachother while\\ trying to spread apart and program can't\\ end while loop causing it to freeze\end{tabular}  \\
\hline
\end{tabular}
\end{table}
...
\begin{tabular}[c]{@{}l@{}}\textbf{Test }\\\textbf{Num}\end{tabular} & \textbf{Input} & \textbf{Expected Result}                                                              & \textbf{Actual Result} & \textbf{What happened/Why it happened}                                                                                                                                 \\ 
\hline
1                                                                    & None           & \begin{tabular}[c]{@{}l@{}}Room spread actually works\\and doesn't crash\end{tabular} & \raisebox{-.5\height}{\includegraphics[width = \testImageSize]{spread rooms}}                          & \begin{tabular}[c]{@{}l@{}}After running the program 5 times it didn't \\crash, previous iteration would freeze every\\time it's ran so it's more robust\end{tabular}  \\
\hline
\end{tabular}
\end{table}
...
\begin{tabular}[c]{@{}l@{}}\textbf{Test }\\\textbf{Num}\end{tabular} & \textbf{Input} & \textbf{Expected Result}                                           & \textbf{Actual Result} & \textbf{What happened/Why it happened}                                                                                                                                    \\ 
\hline
1                                                                    & None           & \begin{tabular}[c]{@{}l@{}}Rooms spread apart\\faster\end{tabular} & \raisebox{-.5\height}{\includegraphics[width = \testImageSize]{room variations spread}}                           & \begin{tabular}[c]{@{}l@{}}Difficult to tell it is actually faster due to\\random nature however, room variations\\were implemented and it still functions.\end{tabular}  \\
\hline
\end{tabular}
\end{table}
...
\begin{tabular}[c]{@{}l@{}}\textbf{Test }\\\textbf{Num}\end{tabular} & \textbf{Input} & \textbf{Expected Result}                                                   & \textbf{Actual Result} & \textbf{What happened/Why it happened}                                                                                                                                       \\ 
\hline
1                                                                    & None           & \begin{tabular}[c]{@{}l@{}}Random amount\\of rooms is deleted\end{tabular} & \raisebox{-.5\height}{\includegraphics[width = \testImageSize]{index out of range error}}             & \begin{tabular}[c]{@{}l@{}}Index out of range error when count \\= GetChildCount() since there is nothing\\ at that index as the last item of the list is\\ GetChildCount()-1.\end{tabular}  \\
\hline
\end{tabular}
\end{table}
...
\begin{tabular}[c]{@{}l@{}}\textbf{Test }\\\textbf{Num}\end{tabular} & \textbf{Input} & \textbf{Expected Result}                                                   & \textbf{Actual Result} & \textbf{What happened/Why it happened}                                                                               \\ 
\hline
1                                                                    & None           & \begin{tabular}[c]{@{}l@{}}Random amount\\of rooms is deleted\end{tabular} & \raisebox{-.5\height}{\includegraphics[width = \testImageSize]{deleted rooms}}              & \begin{tabular}[c]{@{}l@{}}Rooms are spread appart further making\\their placement appear more random.\end{tabular}  \\
\hline
\end{tabular}
\end{table}
...
Checking weather two edges are composed of the same points is problematic since C\# checks weather they are the same so comparing two edges may not work for all cases. This iteration adds the HasPoints method which allows me to check if two edges are the same or if an edge is composed of two specific points. This is useful as when comparing two edges, they could be made up of the same points however since they are in different instances they wouldn't be considered as the same edge, for my use case I want to consider them as the same edge, this method allows me to accomplish this
\begin{lstlisting}
public class Edge
{
    public Point[] points = new Point[2]; // 2 points make an edge
...
\myparagraph{Edge Class Iteration 3}
...
\myparagraph{Bowyer Watson Algorithm Iteration 1}
...
\myparagraph{Bowyer Watson Algorithm Iteration 1 Testing}
\begin{table}[H]
\centering
\begin{tabular}{|l|l|l|l|l|} 
\hline
\begin{tabular}[c]{@{}l@{}}\textbf{Test }\\\textbf{Num}\end{tabular} & \textbf{Input} & \textbf{Expected Result}                                                   & \textbf{Actual Result} & \textbf{Why it happened/What happened}                                                                                                                                               \\ 
\hline
1                                                                    & None           & \begin{tabular}[c]{@{}l@{}}Triangulation\\between all points\end{tabular}  & \raisebox{-.5\height}{\includegraphics[width = \testImageSize]{triangulation not responding}}             & Stops responding because a loop isn't closed                                                                                                                                         \\ 
\hline
2                                                                    & None           & \begin{tabular}[c]{@{}l@{}}Triangulation \\between all points\end{tabular} & \raisebox{-.5\height}{\includegraphics[width = \testImageSize]{circumcenter not correct}} & \begin{tabular}[c]{@{}l@{}}Circumcentre wasn't calculated correctly\\so generation messed up.~ Will need to\\alter the find circumcentre method in the\\triangle class\end{tabular}  \\ 
\hline
3                                                                    & None           & \begin{tabular}[c]{@{}l@{}}Triangulation\\between all points\end{tabular}  & \raisebox{-.5\height}{\includegraphics[width = \testImageSize]{doesnt remove some edges}}             & \begin{tabular}[c]{@{}l@{}}Some of the edges that were meant to be\\removed when adding a new point aren't~\\removed\end{tabular}                                                    \\
\hline
\end{tabular}
\end{table}

\myparagraph{Bowyer Watson Algorithm Iteration 2}
...
\myparagraph{Bowyer Watson Algorithm Iteration 2 Testing}
\begin{table}[H]
\centering
\begin{tabular}{|l|l|l|l|l|} 
\hline
\begin{tabular}[c]{@{}l@{}}\textbf{Test }\\\textbf{Num}\end{tabular} & \textbf{Input} & \textbf{Expected Result}                                                   & \textbf{Actual Result} & \textbf{Why it happened/What happened}                                                                                                  \\ 
\hline
1                                                                    & None           & \begin{tabular}[c]{@{}l@{}}Triangulation\\between all points\end{tabular}  & \raisebox{-.5\height}{\includegraphics[width = \testImageSize]{super tri not removed}} & \begin{tabular}[c]{@{}l@{}}Doesn't remove triangles containing\\super tri points at the end\end{tabular}                                \\ 
\hline
2                                                                    & None           & \begin{tabular}[c]{@{}l@{}}Triangulation \\between all points\end{tabular} & \raisebox{-.5\height}{\includegraphics[width = \testImageSize]{rooms deluaney triangulation}}             & Triangulates all points successfully~                                                                                                   \\ 
\hline
3                                                                    & None           & \begin{tabular}[c]{@{}l@{}}Triangulation\\between all points\end{tabular}  & \raisebox{-.5\height}{\includegraphics[width = \testImageSize]{deluaney triangulation stress test}} & \begin{tabular}[c]{@{}l@{}}Triangulated all points successfully\\even when there was an abnormally\\large amount of rooms\end{tabular}  \\
\hline
\end{tabular}
\end{table}
...
\begin{tabular}[c]{@{}l@{}}\textbf{Test }\\\textbf{Num}\end{tabular} & \textbf{Input} & \textbf{Expected Result}                                                    & \textbf{Actual Result} & \textbf{What happened/Why it happened}                                                                                                                                                                    \\ 
\hline
1                                                                    & None           & \begin{tabular}[c]{@{}l@{}}Random amount of \\edges is removed\end{tabular} & \raisebox{-.5\height}{\includegraphics[width = \testImageSize]{deleted edges}} & \begin{tabular}[c]{@{}l@{}}Random amount of rooms is deleted\\however it deletes all references of an\\edge rather than just the instance in the\\list breaking the rest of the generation.\end{tabular}  \\
\hline
\end{tabular}
\end{table}
...
\begin{tabular}[c]{@{}l@{}}\textbf{Test }\\\textbf{Num}\end{tabular} & \textbf{Input} & \textbf{Expected Result}                                                    & \textbf{Actual Result} & \textbf{What happened/Why it happened}                                                                                  \\ 
\hline
1                                                                    & None           & \begin{tabular}[c]{@{}l@{}}Random amount of \\edges is removed\end{tabular} & \raisebox{-.5\height}{\includegraphics[width = \testImageSize]{remove edges not random}} & \begin{tabular}[c]{@{}l@{}}The selection of edges isn't random\\and some sections are biased over\\others\end{tabular}  \\
\hline
\end{tabular}
\end{table}
...
\begin{tabular}[c]{@{}l@{}}\textbf{Test }\\\textbf{Num}\end{tabular} & \textbf{Input} & \textbf{Expected Result}                                                    & \textbf{Actual Result} & \textbf{What happened/Why it happened}                                                                                        \\ 
\hline
1                                                                    & None           & \begin{tabular}[c]{@{}l@{}}Random amount of \\edges is removed\end{tabular} & \raisebox{-.5\height}{\includegraphics[width = \testImageSize]{rand edges removed}} & \begin{tabular}[c]{@{}l@{}}Random edge is selected and kept, but\\it has same effect as deleting a random\\edge\end{tabular}  \\
\hline
\end{tabular}
\end{table}
...
\myparagraph{Connecting sections Iteration 2 Testing}
\begin{table}
\centering
\begin{tabular}{|l|l|l|l|l|} 
\hline
\begin{tabular}[c]{@{}l@{}}\textbf{Test }\\\textbf{Num}\end{tabular} & \textbf{Input} & \textbf{Expected Result}                                                             & \textbf{Actual Result} & \textbf{What happened/Why it happened}                                                                                                                                                                                        \\ 
\hline
1                                                                    & None           & \begin{tabular}[c]{@{}l@{}}Adds edges until\\there is only one\\section\end{tabular} & \raisebox{-.5\height}{\includegraphics[width = \testImageSize]{freeze on sections}} & \begin{tabular}[c]{@{}l@{}}Recursive algorithm end condition didn't\\work properly so the function kept calling\\itself until the program crashed.\end{tabular}                                                               \\ 
\hline
2                                                                    & None           & \begin{tabular}[c]{@{}l@{}}Adds edges until\\there is only one\\section\end{tabular} & \raisebox{-.5\height}{\includegraphics[width = \testImageSize]{sections wrong stats}} & \begin{tabular}[c]{@{}l@{}}When turning list of edges into graph the\\connected points aren't cleared and are\\added on top of the old ones so their\\connected to points they aren't meant to\\be connected to\end{tabular}  \\ 
\hline
4                                                                    & None           & \begin{tabular}[c]{@{}l@{}}Adds edges until\\there is only one\\section\end{tabular} & \raisebox{-.5\height}{\includegraphics[width = \testImageSize]{sections connected}}  & \begin{tabular}[c]{@{}l@{}}Algorithm adds edges untill there is onlt\\one section left as intended\end{tabular}                                                                                                               \\
\hline
\end{tabular}
\end{table}
...
\begin{tabular}[c]{@{}l@{}}\textbf{Test }\\\textbf{Num}\end{tabular} & \textbf{Input} & \textbf{Expected Result}                                                                                     & \textbf{Actual Result} & \textbf{What happened/Why it happened}                                                                                 \\ 
\hline
1                                                                    & None           & \begin{tabular}[c]{@{}l@{}}Spawn room at top\\boss room at bottom\\(rooms represented\\in blue)\end{tabular} & \raisebox{-.5\height}{\includegraphics[width = \testImageSize]{spawnboss fail}} & \begin{tabular}[c]{@{}l@{}}Didn't check if the closest point is\\itself, so it connectes itself to itself\end{tabular}  \\ 
\hline
3                                                                    & None           & \begin{tabular}[c]{@{}l@{}}Spawn room at top\\boss room at bottom\\(rooms represented\\in blue)\end{tabular} & \raisebox{-.5\height}{\includegraphics[width = \testImageSize]{spawnboss room generated}}             & \begin{tabular}[c]{@{}l@{}}Correctly generate above and below\\respectively\end{tabular}                               \\
\hline
\end{tabular}
\end{table}
...
\begin{tabular}[c]{@{}l@{}}\textbf{Test }\\\textbf{Num}\end{tabular} & \textbf{Input} & \textbf{Expected Result}                                                                              & \textbf{Actual Result} & \textbf{Why it happened/What happened}  \\ 
\hline
1                                                                    & None           & \begin{tabular}[c]{@{}l@{}}Horizontal and\\vertical edges are\\connecting all the\\rooms\end{tabular} & \raisebox{-.5\height}{\includegraphics[width = \testImageSize]{bad horizontal + vert}} & Some rooms are unreachable              \\
\hline
\end{tabular}
\end{table}
...
\begin{tabular}[c]{@{}l@{}}\textbf{Test }\\\textbf{Num}\end{tabular} & \textbf{Input} & \textbf{Expected Result}                                                                          & \textbf{Actual Result} & \textbf{What happened/Why it happened}                                                                 \\ 
\hline
1                                                                    & None           & \begin{tabular}[c]{@{}l@{}}All rooms connected \\with horizontal and\\vertical edges\end{tabular} & \raisebox{-.5\height}{\includegraphics[width = \testImageSize]{up down lines}} & Edges generate correctly                                                                               \\ 
\hline
2                                                                    & None           & \begin{tabular}[c]{@{}l@{}}Corridor generated\\on each edge\end{tabular}                          & \raisebox{-.5\height}{\includegraphics[width = \testImageSize]{corridor error}} & Scale of corridor is wrong                                                                             \\ 
\hline
3                                                                    & None           & \begin{tabular}[c]{@{}l@{}}Corridor generated\\on each edge\end{tabular}                          & \raisebox{-.5\height}{\includegraphics[width = \testImageSize]{coridoors and edges}} & \begin{tabular}[c]{@{}l@{}}All rooms connected~ with horizontal \\and vertical corridors, green represents\\corridors, pink representes edges\end{tabular}  \\
\hline
\end{tabular}
\end{table}
...
\begin{tabular}[c]{@{}l@{}}\textbf{Test }\\\textbf{Num}\end{tabular} & \textbf{Input} & \textbf{Expected Result} & \textbf{Actual Result} & \textbf{Why it happened/What happened}                                                                                      \\ 
\hline
1                                                                    & None           & Tile map generates       & \raisebox{-.5\height}{\includegraphics[width = \testImageSize]{Nothing happened}} & \begin{tabular}[c]{@{}l@{}}Tries to take tile from wrong tile \\map which doesn't exist so nothing\\generates\end{tabular}  \\ 
\hline
2                                                                    & None           & Tile map generates       & \raisebox{-.5\height}{\includegraphics[width = \testImageSize]{one tilemap at time}} & \begin{tabular}[c]{@{}l@{}}Generates one tile at a time which\\takes too long to be productive,\\generated 6 layers in about 40\\seconds and still has a couple\\thousand layers to go\end{tabular}               \\
\hline
\end{tabular}
\end{table}
...
\begin{tabular}[c]{@{}l@{}}\textbf{Test }\\\textbf{Num}\end{tabular} & \textbf{Input} & \textbf{Expected Result} & \textbf{Actual Result} & \textbf{Why it happened/What happened}                                                                              \\ 
\hline
1                                                                    & None           & Tile map generates       & \raisebox{-.5\height}{\includegraphics[width = \testImageSize]{tilemap wrong pos}} & \begin{tabular}[c]{@{}l@{}}Checks wrong area as position isn't\\set correctly\end{tabular}                          \\ 
\hline
2                                                                    & None           & Tile map generates       & \raisebox{-.5\height}{\includegraphics[width = \testImageSize]{drawn tilemap}} & \begin{tabular}[c]{@{}l@{}}Room generated correctly however\\there is no variation in tiles generated\end{tabular}  \\
\hline
\end{tabular}
\end{table}
...
\begin{tabular}[c]{@{}l@{}}\textbf{Test }\\\textbf{Num}\end{tabular} & \textbf{Input} & \textbf{Expected Result}                                                                        & \textbf{Actual Result} & \textbf{Why it happened/What happened}                                                                                                  \\ 
\hline
1                                                                    & None           & Tile map generates                                                                              & \raisebox{-.5\height}{\includegraphics[width = \testImageSize]{made rooms bigger}} & There are room variations generated                                                                                                     \\ 
\hline
2                                                                    & None           & \begin{tabular}[c]{@{}l@{}}Room generates\\with it's platform\\inside the rooms\end{tabular}    & \raisebox{-.5\height}{\includegraphics[width = \testImageSize]{room in tilemap}} & \begin{tabular}[c]{@{}l@{}}Room generates in the tile map and\\all platforms work however border\\generates over corridor\end{tabular}  \\ 
\hline
3                                                                    & None           & \begin{tabular}[c]{@{}l@{}}Holes generate \\between room border\\and corridor\end{tabular}      & \raisebox{-.5\height}{\includegraphics[width = \testImageSize]{room in tilemap with coridoor holes}} & \begin{tabular}[c]{@{}l@{}}Rooms are able to be left since there are\\now holes generated between corridors\\and rooms\end{tabular}     \\ 
\hline
4                                                                    & None           & \begin{tabular}[c]{@{}l@{}}More variation in\\the tiles generated\end{tabular}                  & \raisebox{-.5\height}{\includegraphics[width = \testImageSize]{better rand scale}} & \begin{tabular}[c]{@{}l@{}}different tile generate for platforms,~\\walls and background\end{tabular}                                   \\ 
\hline
5                                                                    & None           & \begin{tabular}[c]{@{}l@{}}Corridors generate\\at regular intervals\end{tabular}                & \raisebox{-.5\height}{\includegraphics[width = \testImageSize]{coridoor platforms no holes}} & \begin{tabular}[c]{@{}l@{}}Generates corridor without holes and\\hence player can't move between them\end{tabular}                      \\ 
\hline
6                                                                    & None           & \begin{tabular}[c]{@{}l@{}}Corridors get holes\\at platforms so they\\aren't solid\end{tabular} & \raisebox{-.5\height}{\includegraphics[width = \testImageSize]{coridoor generation working}} & \begin{tabular}[c]{@{}l@{}}Corridor generation works correctly,\\however there is hole on left side of\\each platform\end{tabular}      \\
\hline
\end{tabular}
\end{table}
...
\begin{tabular}[c]{@{}l@{}}\textbf{Test }\\\textbf{Num}\end{tabular} & \textbf{Input} & \textbf{Expected Result}                                                         & \textbf{Actual Result} & \textbf{Why it happened/What happened}                                                                                                              \\ 
\hline
1                                                                    & None           & \begin{tabular}[c]{@{}l@{}}Hole no longer\\generates on left\\side\end{tabular}  & \raisebox{-.5\height}{\includegraphics[width = \testImageSize]{coridoor doesnt work}} & \begin{tabular}[c]{@{}l@{}}Hole no longer generates but only\\one platform generates\end{tabular}                                                   \\ 
\hline
2                                                                    & None           & \begin{tabular}[c]{@{}l@{}}Platforms generate\\correctly with holes\end{tabular} & \raisebox{-.5\height}{\includegraphics[width = \testImageSize]{coridoor generation working}}             & \begin{tabular}[c]{@{}l@{}}Platforms generate correctly with\\regular holes and platforms\end{tabular}                                              \\ 
\hline
3                                                                    & None           & \begin{tabular}[c]{@{}l@{}}Add borders to the\\corridors\end{tabular}            & \raisebox{-.5\height}{\includegraphics[width = \testImageSize]{problem with coridoor borders}} & \begin{tabular}[c]{@{}l@{}}Borders generate when corridors are\\overlapping and it fails to deal with\\that so I will revert the code\end{tabular}  \\
\hline
\end{tabular}
\end{table}

These algorithm could be improved further, however I have a limited amount of time and further development would be redundant as there are other, more important features to focus on and develop.
...
\begin{tabular}[c]{@{}l@{}}\textbf{Test }\\\textbf{Num}\end{tabular} & \textbf{Input} & \textbf{Expected Result}                                                     & \textbf{Actual Result} & \textbf{Why it happened/What happened}                                                                         \\ 
\hline
1                                                                    & None           & \begin{tabular}[c]{@{}l@{}}Player generates\\at random position\end{tabular} & \raisebox{-.5\height}{\includegraphics[width = \testImageSize]{bad spawn}} & \begin{tabular}[c]{@{}l@{}}Camera didn't update to player~\\camera but player position is random\end{tabular}  \\
\hline
\end{tabular}
\end{table}
...
\begin{tabular}[c]{@{}l@{}}\textbf{Test }\\\textbf{Num}\end{tabular} & \textbf{Input} & \textbf{Expected Result}                                                & \textbf{Actual Result} & \textbf{Why it happened/What happened}                                                                  \\ 
\hline
1                                                                    & None           & \begin{tabular}[c]{@{}l@{}}Player generates\\in spawn room\end{tabular} & \raisebox{-.5\height}{\includegraphics[width = \testImageSize]{player gen in spawn}} & \begin{tabular}[c]{@{}l@{}}Camera switches to player camera\\and spawns in the spawn room\end{tabular}  \\
\hline
\end{tabular}
\end{table}

\subsection{UI input validation}
The player needs some sort of name that the program can refer to the player as. However this name can't be too long since it would break some of the formatting the the UI. Therefore I will limit the display name to 12 characters.
...
Add something here to make it look good
\subsubsection{User Interface}
The main menu was somewhat successful with 2/3 mandatory goals achieved and 0/2 optional goals. So there is a lot of room for improvement, but most of the basic functionality is there.
...
The rest of the user interface wasn't developed as the pause menu and the HUD (heads up display) wasn't developed so they weren't successful at all need to be developed in the future
...
3/5 of the goals have been achieved, the goals which haven't been achieved rely on features that haven't been implemented yet. Those being are there objects you can interact with that give items, however an item system hasn't been implemented yet. 
...
5/5 of the goals for this section have been met. Though I didn't have enough time to write up the process. Though all the goals have been met they may not be fully developed. When play testing Ethan mentioned that the movement doesn't feel that smooth, so it's something I may consider developing in the future, however there are other goals that are more important.
...
\myparagraph{Player}
2/5 of the goals are achieved since some of the animations have been created however they haven't been implemented into the game. The player was designed to fit the enemies as I was able to find an asset pack containing sprite sheets for enemies at \cite{pixel_art}.
...
\myparagraph{Enemies}
All enemy sprite sheets have been take from \cite{pixel_art}. Though none of the enemies have been created all the art is present which makes it easy to implement in the future. With this 5/7 of the goals have been achieved. Leaving only the implementation.
...
1/2 of the goals have been achieved. This is enough for the game to function, however there is room for improvement.
