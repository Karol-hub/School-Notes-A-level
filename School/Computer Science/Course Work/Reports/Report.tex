...
\hline
\begin{tabular}[c]{@{}l@{}}\textbf{Test}\\ \textbf{Num}\end{tabular} & \textbf{Input} & \textbf{Aim}                                                                                & \textbf{Justification}                                              \\ \hline
...
\begin{tabular}[c]{@{}l@{}}\textbf{Test}\\ \textbf{Num}\end{tabular} & \textbf{Input} & \textbf{Aim}                                                                                & \textbf{Justification}                                              \\ \hline
1                                                  & None  & \begin{tabular}[c]{@{}l@{}}Executes in a reasonable \\ amount of time\end{tabular} & Annoying for player to wait too long for level to generate                                                                \\ \hline
2                                                  & None  & \begin{tabular}[c]{@{}l@{}}Random amount of edges\\ are removed\end{tabular}       & \begin{tabular}[c]{@{}l@{}}Every room won't be connected to every other room that's close\\ adding variation\end{tabular} \\ \hline
\end{tabular}
\end{table}
\parBr
...
\begin{tabular}[c]{@{}l@{}}\textbf{Test}\\ \textbf{Num}\end{tabular} & \textbf{Input} & \textbf{Aim}                                                                                & \textbf{Justification}                                              \\ \hline
1                                                  & None  & \begin{tabular}[c]{@{}l@{}}Executes in a reasonable \\ amount of time\end{tabular} & Annoying for player to wait too long for level to generate                                                              \\ \hline
2                                                  & None  & \begin{tabular}[c]{@{}l@{}}Variation in the tiles looks\\ good\end{tabular}        & Makes it engaging for the player and more enjoyable                                                                     \\ \hline
3                                                  & None  & Makes interesting map                                                              & \begin{tabular}[c]{@{}l@{}}Makes it entertaining for player to explore and actualy able\\ to interact with\end{tabular} \\ \hline
\end{tabular}
\end{table}
...
\hline
\begin{tabular}[c]{@{}l@{}}\textbf{Test }\\\textbf{Num}\end{tabular} & \textbf{Input} & \textbf{Expected Result}                                                                                & \textbf{Actual Result} & \textbf{Improvements for future}                                                                                                 \\ 
\hline
