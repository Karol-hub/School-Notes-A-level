...
From the success criteria I have decided that the main menu needs 4 buttons those being: play, tutorial, options and exit buttons. To make these more accessible there can be icons added to clarify what the buttons do with icons commonly associated with their respective function.
...
\begin{tabular}{|l|l|l|l|}
\hline
\textbf{\begin{tabular}[c]{@{}l@{}}Goal\\ Num\end{tabular}} & \textbf{Input}                                                    & \textbf{Aim}                                                                                                     & Justification                                                                                                          \\ \hline
1                                                           & \begin{tabular}[c]{@{}l@{}}text input\\ into textbox\end{tabular} & \begin{tabular}[c]{@{}l@{}}When the amount of character exceeds\\ 12 dont accept any new characters\end{tabular} & \begin{tabular}[c]{@{}l@{}}Having a display name too large can break the\\ formatting in other UI elemets\end{tabular} \\ \hline
\end{tabular}%
}
\end{table}
...
\begin{tabular}{|l|l|l|l|l|}
\hline
\textbf{\begin{tabular}[c]{@{}l@{}}Test\\ Num\end{tabular}} & \textbf{Input}                                                        & \textbf{Exprected Result}                                                                                 & \textbf{Actual Result} & \textbf{Why it happened/What happened}                                                                          \\ \hline
1                                                           & \begin{tabular}[c]{@{}l@{}}Typing\\ text into \\ textbox\end{tabular} & \begin{tabular}[c]{@{}l@{}}Text box won't accept\\ any more characters\\ after 11 characters\end{tabular} & \raisebox{-.5\height}{\includegraphics[width = \testImageSize]{name text}}             & \begin{tabular}[c]{@{}l@{}}Text box won't accept any more characters\\ after 12 characters inputed\end{tabular} \\ \hline
\end{tabular}%
}
\end{table}
