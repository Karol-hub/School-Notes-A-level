...
\hline
1                                                                    & None           & \begin{tabular}[c]{@{}l@{}}Rooms generated in a \\dense section around \\coordinates (0,0)\end{tabular} & \raisebox{-.5\height}{\includegraphics[width = 0.2\textwidth]{Failed to build}}             & \begin{tabular}[c]{@{}l@{}}Tried to access Node's position which doesn't\\~exist, need to access Area2D's position\end{tabular}  \\ 
\hline
2                                                                    & None           & \begin{tabular}[c]{@{}l@{}}Rooms generated in a \\dense section around \\coordinates (0,0)\end{tabular} & \raisebox{-.5\height}{\includegraphics[width = 0.2\textwidth]{Nothing happened}}             & \begin{tabular}[c]{@{}l@{}}Forgot to assign a parent to the rooms so they \\didn't generate at all.\end{tabular}                 \\ 
\hline
3                                                                    & None           & \begin{tabular}[c]{@{}l@{}}Rooms generated in a \\dense section around \\coordinates (0,0)\end{tabular} & \raisebox{-.5\height}{\includegraphics[width = 0.2\textwidth]{rooms generated successful}}             & \begin{tabular}[c]{@{}l@{}}Will be improved upon in the next iteration, \\but functions currently\end{tabular}                   \\
\hline
\end{tabular}
\end{table}
...
\begin{tabular}[c]{@{}l@{}}\textbf{Test }\\\textbf{Num}\end{tabular} & \textbf{Input} & \textbf{Expected Result}                                                      & \textbf{Actual Result} & \textbf{Why it happened/What happened}    \\ 
\hline
1                                                                    & None           & \begin{tabular}[c]{@{}l@{}}Rooms generated in a\\less dense area\end{tabular} & \raisebox{-.5\height}{\includegraphics[width = 0.2\textwidth]{less dense gen}}             & Rooms are generated in a less dense area  \\
\hline
\end{tabular}
\end{table}
...
\begin{tabular}[c]{@{}l@{}}\textbf{Test }\\\textbf{Num}\end{tabular} & \textbf{Input} & \textbf{Expected Result}                                                & \textbf{Actual Result} & \textbf{Why it happened/What happened}                                                                                \\ 
\hline
1                                                                    & None           & \begin{tabular}[c]{@{}l@{}}Rooms structure has \\variation\end{tabular} & \raisebox{-.5\height}{\includegraphics[width = 0.2\textwidth]{less dense gen room variations}}             & \begin{tabular}[c]{@{}l@{}}Difficult to tell but there is more variation\\in the structure of the rooms\end{tabular}  \\
\hline
\end{tabular}
\end{table}
...
\begin{tabular}[c]{@{}l@{}}\textbf{Test }\\\textbf{Num}\end{tabular} & \textbf{Input} & \textbf{Expected Result}                                                     & \textbf{Actual Result} & \textbf{Why it happened/What happened}    \\ 
\hline
1                                                                    & None           & \begin{tabular}[c]{@{}l@{}}Rooms structure has \\more variation\end{tabular} & \raisebox{-.5\height}{\includegraphics[width = 0.2\textwidth]{room variations generation}} & Easier to tell with less rooms generated  \\
\hline
\end{tabular}
\end{table}
...
\begin{tabular}[c]{@{}l@{}}\textbf{Test }\\\textbf{Num}\end{tabular} & \textbf{Input} & \textbf{Expected Result}                                                            & \textbf{Actual Result} & \textbf{Why it happened/What happened}                                                                                                                                 \\ 
\hline
1                                                                    & None           & \begin{tabular}[c]{@{}l@{}}Rooms are spread apart\\without any overlap\end{tabular} & \raisebox{-.5\height}{\includegraphics[width = 0.2\textwidth]{rooms seperated}}             & \begin{tabular}[c]{@{}l@{}}Eventually the program seperates all\\rooms, it did take around 40-50 seconds\\which is too long to be considered\\successful\end{tabular}  \\
\hline
\end{tabular}
\end{table}
