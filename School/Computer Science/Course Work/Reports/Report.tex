...
This iteration didn't make use of the switching between states, which makes it disorganised. It also contains print statements for debugging so I can identify where errors arise.
\begin{lstlisting}
