...
\node (pro1) [process, below of=in1, yshift = -2cm] {Game loads};
\node (pro2) [process, left of=pro1, xshift=-2cm] {Settings Load};
\node (in2) [io, below of=in1, xshift =-5cm] {Player returns to main menu}; 
\node (load) [startstop, below of=in1, yshift = -2cm] {Game Starts};
\node (quit) [startstop, right of=pro1, xshift = 2cm] {Quits Game};
